 ...
 * @property Dm_dan_toc_model $Dm_dan_toc_model
 * @property Fileupload $fileupload
 */



class Dantoc extends REST_INSTANCE_Controller
{
    public function __construct()
    {
        parent::__construct();
        $this->load->helper('url');
        $this->load->model(['Dm_dan_toc_model']);
    }
    ...
    public function index_get()
    {
        ...
        $data = $this->Dm_dan_toc_model->getAll($start, $length, $searchValue);
    ...
    public function create_post()
    {
        ...
        $customMessages = [
            'ten.required' => 'Tên dân tộc bắt buộc nhập',
        ];
        ...
        //Lưu văn bản đến
        $result = $this->Dm_dan_toc_model->create($data);
