...
class Vanbandidonvi extends REST_INSTANCE_Controller
{
    ...
    public function index_get()
    {
        ...
        $response = $this->E_van_ban_model->getAllVanbandidonvi($data['start'], $data['length'], $data['searchValue'], $data['order'], $data['columns'], $data['searchKey'],  $data['fromDate'], $data['toDate'], $auth);
    ...
    public function create_post()
    {
        ...
        if ($ids_don_vi_xu_ly) {
            ...
            $donvithongbaoIds = explode(',', $ids_don_vi_xu_ly);
    ...
    public function update_post($id)
    {
        ...
        $this->E_vb_khoi_co_quan_model->where('id_van_ban', $id)->delete();

        $this->E_vb_co_quan_model->where('id_van_ban', $id)->delete();
        ...
        if ($ids_don_vi_xu_ly) {
            ...
            foreach ($ids_don_vi_xu_ly_array as $id_don_vi_xu_ly) {
    ...
    public function view_log_get()
    {
        $log = $this->Ql_nhat_ky_model
            ...
            ->where('ql_nhat_ky_controller', 'vanbandidonvi')
