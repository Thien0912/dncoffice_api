...
class Trashvanbandi extends REST_INSTANCE_Controller
{
    ...
    public function index_get()
    {
        ...
        $data = $this->E_van_ban_model->getTrashVanbandi($start, $length, $searchValue, $orderBy, $searchKey, $fromDate, $toDate);
    ...
    public function restore_post()
    {
        ...
        $this->db->trans_start();
        $vanban = $this->E_van_ban_model->where('loai_van_ban', $this->common::VAN_BAN_DI)->whereIn('id_van_ban', $ids)->where('deleted_at IS NOT NULL')->get();
        ...
        $this->createLog('restore', 'Khôi phục văn bản đi', $vanban, null, 'e_van_ban');
    ...
    public function force_delete_post()
    {
        ...
        $this->createLog('delete', 'Xóa vĩnh viễn văn bản đi', $vanban,  null, 'e_van_ban');
        $this->db->trans_commit();
