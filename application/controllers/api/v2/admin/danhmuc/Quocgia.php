 ...
 * @property Dm_quoc_gia_model $Dm_quoc_gia_model
 * @property Fileupload $fileupload
 */



class Quocgia extends REST_INSTANCE_Controller
{
    public function __construct()
    {
        parent::__construct();
        $this->load->helper('url');
        $this->load->model(['Dm_quoc_gia_model']);
    }
    ...
    public function index_get()
    {
        ...
        $data = $this->Dm_quoc_gia_model->getAll($start, $length, $searchValue);
    ...
    public function create_post()
    {
        ...
        $customMessages = [
            'ten.required' => 'Tên quốc gia bắt buộc nhập',
        ];
        ...
        //Lưu văn bản đến
        $result = $this->Dm_quoc_gia_model->create($data);
