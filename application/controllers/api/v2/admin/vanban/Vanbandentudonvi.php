...
class Vanbandentudonvi extends REST_INSTANCE_Controller
{
    ...
    public function index_get()
    {
        ...
        $data = $this->E_van_ban_model->getAllVanBanDenTuDonVi($start, $length, $searchValue, $orderBy, $searchKey, $fromDate, $toDate, $auth);
    ...
    public function bao_cao_phan_hoi_create_post($id)
    {
        ...
        $folderName = 'documents/' . date('Y') . '/' . date('m');
        if (isset($_FILES['dinh_kem']) && $_FILES['dinh_kem']['error'] === UPLOAD_ERR_OK) {
