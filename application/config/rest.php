...
|
*/
$config['enable_emulate_request'] = FALSE; // Enable emulate request
...
|
*/
$config['rest_ip_whitelist'] = '103.179.190.138, 113.161.210.124, 113.161.210.125, 14.241.182.40, ::1, 10.10.2.30';
...
$config['rest_jwt_token'] = true;


$config['rest_jwt_token_key'] = '@cntt@dhnct@';
$config['rest_jwt_token_header_key'] = 'DHNCT-Authorization';
$config['rest_token_sso_key'] = 'sso-authorization';
...
|
*/
$config['rest_enable_keys'] = true; //true thì sẽ cần rest_jwt_token_key
...
|
*/
$config['rest_key_name'] = 'DHNCT-API-KEY';
...
|
*/
// $config['allowed_cors_origins'] = ['https://bpt.vieit.net/api.php', 'http://localhost:8080/test/dangnhap', 'http://localhost:5173'];
$config['allowed_cors_origins'] = [
  'http://localhost',
  'http://localhost:5173',
  'https://myoffice.sandboxnctu.qzz.io',
  'https://myoffice.nctu.edu.vn',
];
// $config['allowed_cors_origins'] = ['*'];
